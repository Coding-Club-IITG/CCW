...
async function seed() {
  try {
    ...
    // Problems
    const problems = [
      { problemId: "1900A", name: "Cover in Water", rating: 800, points: 100 },
      { problemId: "1900B", name: "Laura and Operations", rating: 1100, points: 200 },
      { problemId: "1900C", name: "Anji's Binary Tree", rating: 1400, points: 300 },
      { problemId: "1900D", name: "Small GCD", rating: 1700, points: 400 },
      { problemId: "1900E", name: "Transitive Graph", rating: 2100, points: 500 }
    ];
